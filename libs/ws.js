#!/usr/bin/node
/*
 * Copyright (C) 2015-2026 Amarisoft
 * WebSocket example version 2026-06-12
 */
...
if (!scriptMode && !quiet)
    console.log("WebSocket remote API tool version 2026-06-12, Copyright (C) 2012-2026 Amarisoft");
